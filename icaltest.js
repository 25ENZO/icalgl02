...
function ecrireDebut() {
  fs.appendFile(argumentEntree+'.ics',
    "BEGIN:VCALENDAR\n"+ 
    "VERSION:2.0\n"+
    "CALSCALE:GREGORIAN\n", function (err) {
      if(err) {
...
//on recupere les lignes sur lequelles sont indiquées les dates et les heures de differents évenements
    ...
    argumentEntree = "complementaire_" + files[0];
    ecrireDebut();
...
function ecrireListeSpec2(a,b,c) {
  ...
  fs.appendFile(argumentEntree+"-interventions.csv", 
